...
function showCareer(key, backTo, opts) {
  ...
  var onetEyebrow = socParam
    ? 'Career Deep Dive · <span class="career-onet-badge">O*NET</span>'
    : 'Career Deep Dive';
  ...
  var skillsPlaceholder = coreSkills.length
    ? coreSkills.concat(otherSkills).map(function (s) {
      return '<span class="skill-pill" style="--skill-fill:0%"><span class="skill-pill-fill" aria-hidden="true"></span><span class="skill-pill-label">' + s + '</span></span>';
    }).join('')
    : '<span class="skill-pill skill-pill--skeleton" aria-hidden="true"></span>'
      + '<span class="skill-pill skill-pill--skeleton" aria-hidden="true"></span>'
      + '<span class="skill-pill skill-pill--skeleton" aria-hidden="true"></span>';
  document.getElementById('career-content').innerHTML = `
    <section class="career-hero">${careerBackHtml(backTo)}<div class="career-hero-eyebrow fade-in"><span class="section-tag career-eyebrow-tag">${onetEyebrow}<span id="career-personal-suffix" hidden> · Personalized for you</span></span></div><h1 class="fade-in">${esc(c.title)}</h1>${provenanceHtml}<p class="tagline fade-in">${esc(c.tagline)}</p>
      ...
      <div class="metrics-row fade-in">
        ...
        <div class="metric-card" data-career-ai-metric><div class="metric-label">AI Automation Risk</div><div class="metric-value"><span data-career-ai-risk>${aiAuto}</span><span style="font-size:0.9rem;font-family:Inter;font-weight:400;color:var(--text-tertiary)">%</span></div><div class="scale-bar-container"><div class="scale-bar"><div class="scale-bar-fill ${aiBarClass}" data-career-ai-bar style="width:0%" data-target="${aiAuto}"></div></div><div class="scale-bar-labels"><span>Low risk</span><span>High risk</span></div></div></div>
      </div></section>
    <section class="career-section"><div class="section-inner"><div class="overview-grid"><div class="overview-text fade-in" data-career-personal="overview"><h3>What you'll actually do</h3><p>${c.overview}</p></div><div class="overview-sidebar fade-in"><h4>Quick facts</h4><div data-career-personal="quickFacts">${Object.entries(c.sidebar).map(([l,v])=>`<div class="sidebar-item"><span class="label">${l}</span><span class="value${l==='O*NET SOC'?' sidebar-value--soc':''}">${v}</span></div>`).join('')}</div></div></div></div></section>
    <section class="career-section career-onet-block" data-career-onet-section${socParam ? '' : ' hidden'}><div class="section-inner"><div class="section-tag fade-in">O*NET Profile</div><h2 class="section-title fade-in">What this role requires</h2><div class="onet-profile-card fade-in"><div class="onet-profile-tabs" data-career-onet="profileTabs" role="tablist"></div><div class="onet-domain-pills" data-career-onet="profilePanels"></div></div></div></section>
    <section class="career-section career-onet-block" data-career-onet-section${socParam ? '' : ' hidden'}><div class="section-inner"><div class="section-tag fade-in">Role demands</div><h2 class="section-title fade-in">Top O*NET requirements</h2><div class="onet-profile-card fade-in"><div class="onet-demand-bars" data-career-onet="demandBars"><p class="onet-dim-empty">Loading O*NET requirements…</p></div></div></div></section>
    <section class="career-section career-onet-block" data-career-onet="matchSection" hidden><div class="section-inner"><div class="section-tag fade-in">Your match</div><h2 class="section-title fade-in">How you compare on O*NET dimensions</h2><p class="onet-match-note fade-in">“You” blends resume/academic background (75%) and quiz personality (25%) when available.</p><div class="onet-profile-card onet-match-panel fade-in"><div data-career-onet="matchPanel"><p class="onet-dim-empty">Sign in and complete the quiz to see your O*NET match profile.</p></div></div></div></section>
    <section class="career-fit-section" style="display:none"><div class="section-inner"><div class="career-fit-header fade-in"><div><div class="section-tag">Your Assessment</div><h2 class="section-title">How this career fits you</h2></div></div><div class="fit-analysis-stack fade-in"><div class="fit-panel fit-panel--assessed" data-career-personal="assessedFit"></div><div class="fit-panel fit-panel--ai" data-career-personal="aiProfile" hidden></div></div></div></section>
    <section class="career-section career-related-section" data-career-personal="relatedCareers" hidden><div class="section-inner"><div class="section-tag fade-in">Explore further</div><h2 class="section-title fade-in">You might also consider</h2><div class="career-related-chips fade-in" data-career-personal="relatedList"></div></div></section>
    <section class="career-section career-resp-section" style="display:none"><div class="section-inner"><div class="section-tag fade-in">Responsibilities</div><h2 class="section-title fade-in">Core responsibilities</h2><ul class="career-resp-list fade-in" data-career-personal="responsibilities"></ul></div></section>
    <section class="career-section"><div class="section-inner"><div class="section-tag fade-in">A Day in the Life</div><h2 class="section-title fade-in">What a typical day looks like</h2><div class="timeline fade-in" data-career-personal="daySchedule">${dayLife.map(i=>`<div class="timeline-item"><div class="timeline-time">${i.time}</div><div class="timeline-content"><h5>${i.title}</h5><p>${i.desc}</p></div></div>`).join('')}</div><p class="day-schedule-note" data-career-personal="dayScheduleNote" hidden></p><div class="fade-in" style="margin-top:28px;text-align:center"><a class="cta-btn" href="simulation.html?slug=${encodeURIComponent(key)}" style="font-size:0.95rem;padding:14px 36px">Don’t just read the day — try it (2 min) →</a></div></div></section>
    <section class="career-section"><div class="section-inner"><div class="section-tag fade-in">Skills Required</div><h2 class="section-title fade-in">What you need to learn</h2><div class="skills-pills fade-in" data-career-personal="skills">${skillsPlaceholder}</div></div></section>
    <section class="career-section"><div class="section-inner"><div class="section-tag fade-in">AI &amp; Automation Outlook</div><h2 class="section-title fade-in">Chance of being replaced by AI</h2><div class="ai-outlook-card fade-in" data-career-personal="aiReplacement"><h4>Overall automation risk: <span data-career-ai-risk>${aiAuto}</span>%</h4><p class="ai-outlook-text">${c.aiOutlook || ''}</p><div class="ai-bar-big"><div class="ai-bar-big-fill ${aiBarClass}" data-career-ai-bar style="width:0%" data-target="${aiAuto}"></div></div><div class="ai-bar-labels"><span>Low risk</span><span>High risk</span></div><div class="ai-tasks">${aiTasks.map(t=>`<div class="ai-task-row"><span class="ai-task-label">${t.task}</span><span class="ai-task-risk risk-${t.risk}">${t.risk==='low'?'Low risk':t.risk==='med'?'Moderate':'High risk'}</span></div>`).join('')}</div></div></div></section>
    <section class="cta-section"><div class="section-inner"><h2 class="section-title fade-in" style="text-align:center">Interested in ${esc(c.title)}?</h2><div class="fade-in"><a class="cta-btn" href="${roadmapHref}">Build Career Roadmap</a><a class="cta-btn cta-btn-outline" href="quiz.html">Take the Career Quiz</a><a class="cta-btn cta-btn-outline" href="coach.html">Talk to Marco</a><a class="cta-btn cta-btn-outline" href="simulation.html?slug=${encodeURIComponent(key)}">Try This Career</a></div></div></section>`;
